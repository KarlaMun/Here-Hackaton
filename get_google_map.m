function [pix2m, satellite_map] = get_google_map(lat, lon, varargin)
...
if isnumeric(apiKey)
    ...
    if exist('api_key.mat','file')
        ...
        apiKey = 'AIzaSyAOSXv-OiT_m5_OEm8kGB9LjyW0FjUQfik';
    end
end
...
M = cast(M,'double');
satellite_map = ind2rgb(M, Mcolor);

% Output the corresponding pix2m factor 
pix2m = 156543.03392 * cos(lat * pi / 180) / power(2, zoomlevel);
